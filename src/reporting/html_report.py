...
def generate_html_report(
    ...
    # Prepare remediation summary if available
    remediation_summary = None
    if remediation_diff:
        sample_changes = []
        for col_name, col_diff in remediation_diff.column_diffs.items():
            for change in col_diff.sample_changes[:5]:
        ...
        remediation_summary = {
            ...
            "sample_changes": sample_changes[:20],
        }
...
<head>
    <meta charset="UTF-8">
    <title>Remediation Summary - {filename}</title>
    <style>
        ...
        .summary {{ background-color: #e8f4fd; padding: 15px; border-radius: 6px; margin: 20px 0; }}
    </style>
</head>
<body>
